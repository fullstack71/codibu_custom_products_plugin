...
function car_status_single_order_meta_box() {
    ...
    <script>
        function printPageArea(areaID){
            ...
            var printContent1 = document.getElementById('header').innerHTML;
            var originalContent = document.body.innerHTML;
            document.body.innerHTML = printContent1+printContent;
            window.print();
            document.body.innerHTML = originalContent;
        }

    </script>
    <button type="button" class="button" style="vertical-align:middle"  onclick="printPageArea('printableArea')"><span>Print </span></button>
    ...
    <div id="printableArea">
        ...
        <table style="margin-top: 50px;">
            ...
            ?>
            <tr>
                <th style="width: 150px;">Visual Brake Check</th>
            ...
            <tr>
                <th style="width: 250px;">Visual Underhood Check</th>
                <th style="width: 50px;"><label class="vertical-label crimson">Red</label></th>
                <th style="width: 50px;"><label class="vertical-label darkgoldenrod">Amber</label></th>
                <th style="width: 50px;"><label class="vertical-label greenyellow">Green</label></th>
                <th style="width: 50px;"><label class="vertical-label">N/C</label></th>
            ...
            <tr>
                <th style="width: 250px;">Tire Tread Depth and Pressure Check</th>
                <th style="width: 50px;"><label class="vertical-label crimson">Red</label></th>
                <th style="width: 50px;"><label class="vertical-label darkgoldenrod">Amber</label></th>
                <th style="width: 50px;"><label class="vertical-label greenyellow">Green</label></th>
                <th style="width: 50px;"><label class="vertical-label">N/C</label></th>
            ...
            <tr>
                ...
                <td class="last-column">
                    <table>
                        <tr>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r15c5s1" value=" <?php echo $car_status["r15c5s1"]?>" ></td>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r15c5s2" value=" <?php echo $car_status["r15c5s2"]?>" ></td>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r15c5s3" value=" <?php echo $car_status["r15c5s3"]?>" ></td>
                            <td class="last-column">
            ...
            <tr>
                ...
                <td class="last-column">
                    <table>
                        <tr>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r16c5s1" value=" <?php echo $car_status["r16c5s1"]?>" ></td>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r16c5s2" value=" <?php echo $car_status["r16c5s2"]?>" ></td>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r16c5s3" value=" <?php echo $car_status["r16c5s3"]?>" ></td>
                            <td class="last-column">
            ...
            <tr>
                ...
                <td class="last-column">
                    <table>
                        <tr>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r17c5s1" value=" <?php echo $car_status["r17c5s1"]?>" ></td>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r17c5s2" value=" <?php echo $car_status["r17c5s2"]?>" ></td>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r17c5s3" value=" <?php echo $car_status["r17c5s3"]?>" ></td>
                            <td class="last-column">
            ...
            <tr>
                ...
                <td class="last-column">
                    <table>
                        <tr>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r18c5s1" value=" <?php echo $car_status["r18c5s1"]?>" ></td>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r18c5s2" value=" <?php echo $car_status["r18c5s2"]?>" ></td>
                            <td style="width: 100px;"><input style="width: 100px;" type="text" name="r18c5s3" value=" <?php echo $car_status["r18c5s3"]?>" ></td>
                            <td class="last-column">
            ...
            <tr>
                <th style="width: 250px;">Visual Exterior Check</th>
                <th style="width: 50px;"><label class="vertical-label crimson">Red</label></th>
                <th style="width: 50px;"><label class="vertical-label darkgoldenrod">Amber</label></th>
                <th style="width: 50px;"><label class="vertical-label greenyellow">Green</label></th>
                <th style="width: 50px;"><label class="vertical-label">N/C</label></th>
            ...
            <tr>
                <th style="width: 250px;">Visual Interior Check</th>
                <th style="width: 50px;"><label class="vertical-label crimson">Red</label></th>
                <th style="width: 50px;"><label class="vertical-label darkgoldenrod">Amber</label></th>
                <th style="width: 50px;"><label class="vertical-label greenyellow">Green</label></th>
                <th style="width: 50px;"><label class="vertical-label">N/C</label></th>
